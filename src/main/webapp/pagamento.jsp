    ...
    <form>
        <div class="pay-method">
            ...
            <div class="radio-inputs">
                <label class="radio">
                    <input type="radio" name="radio" checked="" onchange="CartadiCredito()">
                    <span class="name">Carta di credito</span>
                </label>
                <label class="radio">
                    <input type="radio" name="radio" onchange="email()">
            ...
            <div class="input-data"  id="email" style="display: none;">
                <h2>Email</h2>
                <input type="email">
            </div>
...
<script src="assets/js/switch-pagamento.js"></script>
<!-- End Script -->
</body>
